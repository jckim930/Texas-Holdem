//
// Created by Rick Mercer on 2019-03-17.
//
#include "catch.hpp"
#include "Card.hpp"
#include <iostream>
...
TEST_CASE("GetValueWitRelationalOps") {
  Card H10{Rank::TEN, Suit::HEARTS};
...
TEST_CASE("addingTwoCards") {
    Card C2{Rank::FIVE, Suit::CLUBS};
    Card C3{Rank::THREE, Suit::CLUBS};
    Card C5{Rank::FIVE, Suit::CLUBS};
    REQUIRE(C5 == 5);
    REQUIRE((C2 < 6) == true);
    REQUIRE((C2 == C5) == true);
    REQUIRE((C2 == 5) == true);
